...
namespace BookStoreCet.Data.Migrations
{
    ...
    [Migration("20230424080536_ordersChanged")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreCet.Data.Book", b =>
                {
                    b.HasOne("BookStoreCet.Data.Category", "Category")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("BookStoreCet.Data.OrderDetail", b =>
                {
                    ...
                    b.HasOne("BookStoreCet.Data.Order", "Order")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookStoreCet.Data.CetUser", null)
                        .WithMany()
